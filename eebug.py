...
def aws_network_graph(eni_details, subnet_details, route_table_details, tgw_details, tgw_attachments):
    ...
    elements.append({'data': {'id': 'github_icon', 'label': 'GitHub', 'type': 'GitHub', 'icon': 'ion:logo-github'}})
            ...
            dbc.Col(
                Cytoscape(
                    ...
                    stylesheet=[
                        ...
                        {'selector': '#github_icon', 'style': {'background-image': 'url(https://ionicons.com/ionicons/ion:logo-github.svg)', 'background-fit': 'cover', 'background-width': '70%', 'background-height': '70%', 'border-color': '#3573A5'}},
